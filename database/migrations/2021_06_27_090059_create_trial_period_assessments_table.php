...
class CreateTrialPeriodAssessmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trial_period_assessments', function (Blueprint $table) {
            $table->id();
            $table->date('date');
    ...
    {
        Schema::dropIfExists('trial_period_assessments');
    }
}
