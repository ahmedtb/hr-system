...
export default function FiltersContainer(props) {
    ...
    return (
        <>
            <div type="button" className="m-2 p-2 btn btn-outline-secondary" data-toggle="collapse" href="#filtersCollapse" role="button" aria-expanded="false" aria-controls="filtersCollapse">
